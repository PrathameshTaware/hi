      ...
      <header className="border-b border-white/10 bg-white/5 backdrop-blur-xl">
        <div className="mx-auto max-w-7xl px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            >
              <div className="text-sm font-medium text-white">Brand: {brand?.name || "Demo Brand"}</div>
                  ...
                  ([platform, content]) => (
                    ...
                    >
                      ...
                      <div className="space-y-3">
                        ...
                        <Floating3DButton
                          onClick={() => console.log("Schedule post", platform)}
                          className="mt-4"
                          size="sm"
                        >
                          Schedule Post <ArrowRight className="h-4 w-4 ml-2" />
                        </Floating3DButton>
                      </div>
                    </motion.div>
                  )
